...
from ...core.connection import broadcast_message, set_current_tab_id, reset_current_tab_id
from ...core.request_context import RequestContext, set_current_request, set_current_model
...
class SchedulerService:
    ...
    async def _run_job_query(self, job: Dict[str, Any]) -> Optional[str]:
        ...
        from ..chat.ollama_global_queue import ollama_global_queue
